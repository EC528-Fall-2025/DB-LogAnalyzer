...
from data_transfer_object.event_dto import EventModel, MANDATORY_FIELDS
...
class LogParser:
    ...
    def load_event_models(self, json_path: str):
        """Load event models from JSON file."""
        ...
        for obj in data:
            ...
            fields_json = (
                json.loads(obj["fields_json"]) if isinstance(obj["fields_json"], str) else obj["fields_json"]
            )
